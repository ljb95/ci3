...
<?php
   $action = (!empty($mem_userid))? '/recommend/member_subscribe':'/recommend/guest_subscribe';
?>
<form method="post" action="<?php echo $action; ?>" name="f">
...
<div id="subscribe_2" >
		...
		<div class="box">
			...
			<div class="week">
				<div class="btns">
					...
					?>
					<p>
						<button type="button" class="btn-period btn-under " id="select_period_4" onclick="javascript:fnSetPeriod(4);">4주 마다</button>
						<span class="desc2 desc_week" id="desc_4week" style="display:none;">다음 결제일 : <label id="desc_4week_day"><?php echo $next_day; ?></label>(<label class="week_val"><?php echo $week; ?></label>요일)</span>
					</p>
					<p>
						<button type="button" class="btn-period btn-under active" id="select_period_12" onclick="javascript:fnSetPeriod(12);">12주 마다</button>
						<span class="desc2 desc_week" id="desc_12week" >다음 결제일 : <label id="desc_12week_day"><?php echo $next_day2; ?></label>(<label class="week_val"><?php echo $week; ?></label>요일)</span>
					</p>
					<p>
						<button type="button" class="btn-period btn-under" id="select_period_16" onclick="javascript:fnSetPeriod(16);">16주 마다</button>
					...
					<input type="hidden" name="delivery_period" value="12"/>
				...
				<div class="end">결제일자 : <span id="show_delivery_day"><?php echo date('Y.m.d', strtotime($start_date)); ?></span>일(<label class="week_val"><?php echo $week; ?></label>요일) /
					<span id="show_delivery_period">12</span>주 마다 선택</div>
	...
	<div class="btn-box-common1">
		<a href="javascript:window.history.back();" class="btn btn-type2" id="btn_step2">이전</a>
		<a href="javascript:f.submit();" class="btn btn-type1" id="">선택완료</a>
	</div>
