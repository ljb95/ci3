...
<div class="inner">
    ...
    <div class="table1 cart-type mb30 pc">
        <table>
            ...
            <tbody>
                <?php
                foreach ($order['list'] as $row) {
                    $unit_price = $row['is_sale'] === 'y' ? $row['cit_sale_price'] : $row['cit_price'];
                    $dis = $row['cit_price'] - $row['cit_subscribe_price'];
                    if ($order['order_type'] === 'recommend')
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="prd-info">
                                <strong><?php echo $row['cit_name']; ?></strong><?php echo '<span>진단상품</span>'; ?>
                        ...
                        ?>
                        <td><strong><?php echo number_format($unit_price); ?>원</strong></td>
                    </tr>
                    <?php
                }
                ?>
    ...
    <div class="order-end-flip">
        <a href="#">
            ...
            <div class="info">
                ...
                <div class="t2">총 결제금액 <?php echo number_format($order['total_price']); ?>원</div>
            </div>
        </a>
    </div>
    <!-- // 모바일 전용 -->
        ...
        <ul>
            ...
            foreach ($order['list'] as $row) {
                ...
                <li>
                    ...
                    <div class="info">
                        <dl>
                            <dt><strong><?php echo $row['cit_name']; ?></strong><?php echo $order['order_type'] === 'recommend' ? '<span>구독상품</span>' : ''; ?></dt>
                            <dd>
                                <div class="opt"><?php echo $row['cde_title']; ?></div>
        ...
        <div class="step1">
            <div class="cart-price pc">
                <div class="orther">
                    ...
                    if ($order['order_type'] === 'recommend') {
                        ...
                        <dl>
                            ...
                            <dd>
                                <?php
                                if ($order['use_coupon'] > 0) {
                                    if ($order['use_coupon_type'] === '3') {
                                        echo '마일리지지급 ' . number_format($order['use_coupon']) . '원';
                                    } else {
                                        echo '-' . number_format($order['use_coupon']) . '원';
                                    }
                                } else {
                                    echo '0원';
                                }
                ...
                <div class="total">
                    <dl>
                        <dt>총 결제금액</dt>
                        <dd><?php echo number_format($order['total_price']); ?> 원</dd>
                    </dl>
                </div>
            </div>
            ...
            <div class="order-info">
                ...
                if ($res['status'] === 'OK') {
                    ...
                    <div class="box">
                        ...
                        <div class="info2">
                            ...
                            if ($order['order_type'] === 'recommend') {
                                ...
                                <dl>
                                    <dt>할인금액</dt>
                                    <dd><strong><?php echo $order['delivery_price'] > 0 ? '- ' . number_format($sum_dis) : '0'; ?></strong> 원</dd>
                                </dl>
                                <?php
                            } else {
                                ?>
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        if ($order['use_coupon'] > 0) {
                                            if ($order['use_coupon_type'] === '3') {
                                                echo '<strong>마일리지지급 ' . number_format($order['use_coupon']) . '</strong>원';
                                            } else {
                                                echo '<strong>-' . number_format($order['use_coupon']) . '</strong>원';
                                            }
                                        } else {
                                            echo '<strong>0</strong>원';
                                        }
                                        ?>
                                    </dd>
                                </dl>
                            ...
                            <dl class="total">
                                <dt>최종결제금액</dt>
                                <dd><small><?php echo $order['order_type'] == 'recommend' ? '정기결제' : ''; ?></small><strong><?php echo number_format($order['total_price']); ?></strong> 원</dd>
                            </dl>
                        </div>
                    </div>
                    <?php
                    ...
                    <div class="box">
                        ...
                        <div class="info2">
                                 <?php if($order['payMethod'] == 'KakaoPay'){
                      ?>
                            <dl>
                                    <dt>결제수단</dt>
                                    <dd>카카오페이</dd>
                            ...
                            <?php
                    }else if ($order['payMethod'] == 'NaverPay'){ 
                        ?>
                            <dl>
                                    <dt>결제수단</dt>
                                    <dd>네이버페이</dd>
                        ...
                        <?php 
                        } else if($order['payMethod'] == 'Card' || $order['payMethod'] == 'CARD' || $order['payMethod'] == 'VCard' || $order['payMethod'] == 'Auth') {
						?>
							<dl>
								<dt>결제수단</dt>
								<dd>카드결제</dd>
						...
						?>
							...
							<!-- 20220405 [진단결과페이지 수정] 카카오페이 결제수단 정보 추가 -->
                        <?php	
							}
							else if($order['payMethod'] == 'KakaoPay') {
						?>
							<dl>
								<dt>결제수단</dt>
								<dd>카카오페이</dd>
            ...
            <div class="btn-box-common1">
                ...
                if ($res['status'] === 'OK') {
                    ...
                    ?>
                    <a href="/cart/cart_list?type=<?php echo $order['order_type']; ?>" class="btn btn-type1">다시 결제 하기</a>
                    <?php
                }
                ?>
            </div>
