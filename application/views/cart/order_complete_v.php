...
if ($res['status'] === 'OK') {
    ...
    if ($order['order_type'] === 'subscribe') {
        ...
        ?>
                            ...
                            <dl class="total">
                                <dt>최종결제금액</dt>
                                <dd><small><?php echo $order['order_type'] == 'subscribe' ? '정기결제' : ''; ?></small><strong><?php echo number_format($order['total_price']); ?></strong> 원</dd>
                            </dl>
                        </div>
                    </div>
    <?php
    if ($order['order_mem_type'] != 'guest' && $order['payDevice'] == 'PC') {
        ?>
                    ...
                    <div class="box">
                        ...
                        <div class="info2">
                    <?php
                    if ($order['payMethod'] == 'Card' || $order['payMethod'] == 'VCard' || $order['payMethod'] == 'Auth') {
                        ?>
                                <dl>
                                    <dt>결제수단</dt>
                                    <dd>카드결제</dd>
        ...
        ?>
                                ...
                                <dl>
                                    <dt>은행명</dt>
                                    <dd class="vbank_font"><?php echo $order['vbank_name']; ?></dd>
                                </dl>
                                <dl>
                                    <dt>계좌번호</dt>
                                    <dd class="vbank_font"><?php echo $order['vbank_num']; ?></dd>
                                </dl>
                                <dl>
                                    <dt>예금주명</dt>
                                    <dd class="vbank_font"><?php echo $order['vbank_owner']; ?></dd>
                                </dl>
                                <dl>
                                    <dt>입금기한</dt>
                                    <dd class="vbank_font"><?php echo date('Y.m.d', strtotime($order['vbank_date'])); ?></dd>
                                </dl>
        <?php
